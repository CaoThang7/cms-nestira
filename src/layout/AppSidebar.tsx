...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
    subItems: [{ name: "Business Statistics", path: "/", pro: false }],
  },
  {
    icon: <UserCircleIcon />,
    name: "Profile Admin",
...
const othersItems: NavItem[] = [
  {
    ...
    icon: <TrashIcon />,
    subItems: [
      { name: "Trash Category", path: "/trash-category", pro: false },
      { name: "Trash Product", path: "/trash-product", pro: false },
    ],
  },
];
...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 z-50 mt-16 flex h-screen flex-col border-r border-gray-200 bg-white px-5 text-gray-900 transition-all duration-300 ease-in-out lg:mt-0 dark:border-gray-800 dark:bg-black ${
          ...
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <Image
                ...
                src="/images/logo/logo-nestira-light.jpg"
                alt="Logo"
                width={120}
                height={42}
                priority
              ...
              <Image
                ...
                src="/images/logo/logo-nestira-dark.jpg"
                alt="Logo"
                width={120}
                height={42}
                priority
